...
resource "aws_iam_role" "github_actions" {
  name = "cloudforge-github-actions-role"
    ...
    Statement = [
      {
        ...
        Condition = {
          ...
          StringLike = {
            "token.actions.githubusercontent.com:sub" = "repo:AkilaIsuri/cloudforge-platform:ref:refs/heads/main"
          }
        }
      }
    ]
...
resource "aws_iam_role_policy" "github_actions_ecr" {
  name = "cloudforge-github-actions-ecr"
